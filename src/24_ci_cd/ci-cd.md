...
2. [没有 CI/CD 时，大家怎么做？](#没有-cicd-时大家怎么做)
3. [CI 和 CD 分别是什么？](#ci-和-cd-分别是什么)
4. [CI/CD 里常见的几个词](#cicd-里常见的几个词)
5. [一条流水线长什么样？](#一条流水线长什么样)
6. [自己搭一条「最小流水线」：GitHub Actions 示例](#自己搭一条最小流水线github-actions-示例)
7. [常见平台与怎么选](#常见平台与怎么选)
8. [从零到「能跑」的检查清单](#从零到能跑的检查清单)
9. [延伸：和发版、Changesets 的关系](#延伸和发版changesets-的关系)
10. [参考链接](#参考链接)
